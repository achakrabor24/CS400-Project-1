...
public class TestClassApp {
  ...
  /**
   * Checks two cases: if file exists and if file does not exist.
  ...
  /**
   * Checks if method correctly identifies a class key.
   * @return
   */
  ...
  /**
   * Checks if method properly retrieves class information given class key.
   * @return
   */
  ...
  /**
   * Checks if a class key and contents is successfully removed.
   * @return
   */
  ...
  /**
   * Tests if all class keys and contents are cleared.
   * @return
   */
